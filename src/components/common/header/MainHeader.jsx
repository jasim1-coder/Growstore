...
const MainHeader = () => {
  ...
  return (
    <div className="flex flex-row py-4 gap-4 items-center justify-between border-b border-greyLight flex-wrap">
      ...
      <div className="flex flex-row gap-10 justify-between items-center sm:flex-none flex-wrap">
        ...
        <Link to="/cart" className="flex flex-row items-center gap-3">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-baseGreen text-[12px]">Rs. 100</span>
          </div>
        </Link>
